    ...
    return Jsonp = function () {
        $.ajax({
            ...
            for (var n in t)
                if (n == "results") {
                    var r = t[n][0].index,
                        i = t[n][0].weather_data;
                    i.forEach(function (e, t, n) {
                        var r = $('<div class="weather"><p>' + JSON.stringify(e.date) + "</p>" + "<img src=" + JSON.stringify(e.dayPictureUrl) + ">" + "<p>" + JSON.stringify(e.temperature) + "</p>" + "<p>" + JSON.stringify(e.weather) + "</p>" + "<p>" + JSON.stringify(e.wind) + "</p>" + "</div>");
                        $(".text").prepend(r)
                    }), r.forEach(function (e, t, n) {
                        var r = $('<div class="weather"><p>' + JSON.stringify(e.title) + "</p>" + "<p>" + JSON.stringify(e.zs) + "</p>" + "<p>" + JSON.stringify(e.tipt) + "</p>" + "<p>" + JSON.stringify(e.des) + "</p>" + "</div>");
                        $(".text").prepend(r)
                    })
                }
        })
    }, Jsonp
}), define("xinlang", [], function () {
    return _Xinlang = function () {
        return xinlang = function () {
            var e = this;
            $.ajax({
        ...
        }, xinlang.prototype.addEvent = function (e) {
            console.log("data:", e);
            var e = e;
            arr = e.data;
            for (var t = 0; t < arr.length; t++) {
                var n = $("<a href=" + arr[t].cmnt_url + ' style="text-decoration: none"><div class="xinlang    ">' + "<img src=" + arr[t].img_url + ">" + "<p>" + arr[t].name + "</p>" + "</div></a>");
                $(".text").append(n)
            }
        }, {
            init: function () {
...
}), require(["jquery", "jsonp", "xinlang"], function () {
    Jsonp(), new _Xinlang.init
